...
colnames(metadata)[2] <- "sample.time"
...
my_colors <- c(
  ...
  "#42aaff", "#ff6666", "#66ff66", "#6666ff", "#ff66ff", "#66ffff", "#ffff66",
  "#ff9999", "#99ff99", "#9999ff", "#ff99ff", "#99ffff", "#ffff99", "#ff0000",
  "#00ff00", "#0000ff", "#ff00ff", "#00ffff", "#ffff00", "#ff9933", "#33ff99"
)

#If you want different taxonomic level, find and replace the taxonomic level listed here
my_level <- c("Phylum", "Family", "Genus")
my_column <- "sample.time"  #this is the metadata column that we will use in the taxa barplot
my_column_ordered <- c("Early","Middle", "Late")
...
for(ml in my_level){
  ...
  ggsave(paste0("output/taxa/", ml, "BarPlot_", my_column, ".png"), height = 5, width = 6)
}
